            ...
            <div className="bg-card backdrop-blur-sm border border-border rounded-2xl p-5">
              ...
              <div className="mt-3 flex gap-2">
                <button
                  ...
                  className="flex-1 bg-ok/15 text-ok border border-emerald-500/30 py-2 rounded-xl hover:bg-emerald-500/30 transition-all disabled:opacity-50 font-medium flex items-center justify-center gap-2 text-lg"
                >
                  <span>🔓</span>
                  {gateLoading ? "..." : "Open"}
                </button>
