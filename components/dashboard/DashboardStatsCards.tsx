...
export default function DashboardStatsCards() {
  const [totalDailyAccesses, setTotalDailyAccesses] = useState(0);
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const totalAccesses = todayEntries.length;

        setTotalDailyAccesses(totalAccesses);
        ...
        const peakTraffic =
          Object.values(trafficByHour).length > 0
            ? Math.max(...Object.values(trafficByHour))
            : 0;
      ...
      >
        ...
        <div className="relative z-10 mt-20">
          <h2
            ...
            "
          >
            {loading ? "..." : totalDailyAccesses.toLocaleString()}
          </h2>
